#!/usr/bin/env python3
"""One configured research-panel preparation, intercepted before loop refinement.
...
def launch():
    ...
    paths = [Path(row['copy']) for row in source_freeze['files']] + [frozen, ROOT / 'capture-configuration.json']
    ...
    plan = {'scope': 'One fresh actual ' + CASE + ' preparation, capture before refinement and publication',
